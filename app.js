...
$("#t_run")?.addEventListener("click", ()=>{
  ...
  cards.forEach((c,idx)=>{
    ...
    el.innerHTML=`<div class="inner">
      ...
      <div class="face front"><div class="row"><span class="badge">${positions[idx]}</span><span class="badge">${reversed?"역방향":"정방향"}</span></div><h4>${c.title}</h4><div class="small"><span class='mobile-hide'>클릭하면 상세 해설이 아래에 표시됩니다.</span></div></div>
    </div>`;
